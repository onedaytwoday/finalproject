...
delete from chatting where chatting_no = 3;
...
select * from payment;
update payment set payment_date = sysdate where payment_no = 8;
...
CREATE TABLE CLASS_LOCATION(
	CLASS_NO NUMBER PRIMARY KEY,
	CLASS_LAT VARCHAR2(100) NOT NULL,
	CLASS_LNG VARCHAR2(100) NOT NULL,
	CONSTRAINT CLASS_LOCATION_CLASS_NO_FK FOREIGN KEY (CLASS_NO) REFERENCES CLASS (CLASS_NO) ON DELETE CASCADE
)

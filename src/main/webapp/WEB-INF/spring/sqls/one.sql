...
INSERT INTO BOARD
VALUES(BOARD_NO_SEQ.NEXTVAL,BOARD_NOTICE_NO_SEQ.NEXTVAL,NULL,'123','123',SYSDATE,0,
0,0,0,'N','N','1234','1702707258')
...
CREATE TABLE  PAYMENT  (
	 ...
	 CONSTRAINT PAYMENT_BASKET_NO_FK FOREIGN KEY (BASKET_NO) REFERENCES BASKET (BASKET_NO) ON DELETE CASCADE,
...
CREATE TABLE  CHATTING (
	 ...
	 CONSTRAINT CHATTING_CHAT_NO_FK FOREIGN KEY (CHAT_NO) REFERENCES CHAT (CHAT_NO) ON DELETE CASCADE
);
...
CREATE TABLE  CHAT  (
	 ...
	 CHAT_DATE 	DATE	,
	 CONSTRAINT CHAT_MEMBER_ID_FK FOREIGN KEY (MEMBER_ID) REFERENCES MEMBER (MEMBER_ID) ON DELETE CASCADE
);

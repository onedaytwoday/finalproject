...
SELECT R.ROOM_NO, R.MEMBER_ID, R.CONSULT_ID, R.ROOM_CONTENT, R.ROOM_DATE ,
	(SELECT COUNT(*) 
	FROM CHATTING C 
	WHERE R.ROOM_NO = C.ROOM_NO
	AND C.CHATTING_READ = 'N') AS cnt
FROM ROOM R
WHERE R.MEMBER_ID = '1702707258'
ORDER BY R.ROOM_NO

SELECT * FROM CHATTING;
UPDATE CHATTING SET CHATTING_READ WHERE ROOM_NO = 2

...
//}
  ...
  //클래스 주소
    var classadd = '서울 중구 한강대로 405 서울역';//나중에 클래스에서 주소값을 받기로 한다.

    //클래스명
    var classname= '서울역';//나중에 클래스에서 클래스명을 받기로 한다...
...
<%-- ----------------------------------------------------------------- --%>
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=b09278ee8c0d306e4d38397589fed58d&libraries=services"></script>
	<script>

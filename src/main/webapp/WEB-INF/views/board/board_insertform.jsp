			...
			<div class="row">
				...
				<div class="col-12">
					<div class="form-group">
						<input class="form-control" name="board_title" type="text"
							placeholder="Title">
					</div>
				</div>
				<div class="col-12">
				...
				<div class="col-2">
					<div class="form-group">
						<input class="form-control" type="text" size="4" name="board_pw" placeholder="password">
					</div>
				</div>
			</div>
			<div class="form-group" align="right">
				<button type="submit" class="button button-contactForm btn_1 boxed-btn" form="board_insertRes">Send</button>
				
				
				<c:choose>
					<c:when test="${board_category eq 'N' }">
					<button type="button" class="button button-contactForm btn_1 boxed-btn" onclick="location.href='board_notice_list.do?nowPage=1'">Cancle</button>
					</c:when>
					<c:when test="${board_category eq 'Q' }">
					<button type="button" class="button button-contactForm btn_1 boxed-btn" onclick="location.href='board_qna_list.do?nowPage=1'">Cancle</button>
					</c:when>
					</c:choose>
			</div>
		</form>

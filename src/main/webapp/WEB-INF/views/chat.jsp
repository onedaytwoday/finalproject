...
<c:set var="profile" value='<%=session.getAttribute("mDto")%>' />
...
<input type="text" id="member_id" value = "${member_id }" style = "display:none">
...
<script type="text/javascript">
 ...
 function send() {
  ...
  if(msg != ""){
	  message = {};
	  message.chat_content = $("#message").val()
  	  message.consult_id = '${consult_id}'

...
<body>
	<header class="header">
		...
		<ul class="login">
			<li><a href="basket.do"
				style="position: relative; text-decoration-line: none;"> <i
					class="bi bi-cart4" style="font-size: 3rem; cursor: pointer;"></i>
					<span id="basket_num"
					style="position: absolute; left: 1.5rem; bottom: 25px; border-radius: 50%; padding: 5px 10px; background-color: red; color: white;">
						${basket_num } </span>
			</a> <a href="mypage_update.do?member_id=${mDto.member_id }">마이페이지</a></li>

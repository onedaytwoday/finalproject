	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#iconImg').click(function(){
	    		window.open('http://132.226.236.97:8787/finalproject/chat_main.do?member_id=${mDto.member_id }' ,'채팅', 'width=500px,height=500px,scrollbars=yes');
	    	});
			$('#Img').click(function(){
	    		window.open('http://132.226.236.97:8787/finalproject/chat_room.do' ,'채팅', 'width=500px,height=500px,scrollbars=yes');
	    	});

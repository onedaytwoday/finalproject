...
public class EventController {
	...
	public String fileUpload(@RequestParam("files") List<MultipartFile> multipartFile, EventDto dto, String start, String end, String sale_rate,HttpServletRequest request) throws ParseException {
		int res = 0;
		dto.setEvent_noti("N");

...
public class SensSmsV2 {
	public static void main(String[] args) {
		...
		toJson.put("subject", "test");			//메시지 내용 * LMS Type에서만 사용 가능
		toJson.put("content", "test");			//메시지 내용 * Type별 최대 byte제한이 다름. * SMS:80/LMS: 2000
		toJson.put("to", "01071826592");				//수신번호 목록
		toArr.add(toJson);				
		...
		bodyJson.put("subject", "test");		//메시지 제목 * LMS Type에서만 사용 가능
		bodyJson.put("content", "test");		//메시지 내용 * Type별 최대 byte제한이 다름. * SMS:80/LMS: 2000
